...
/* harmony export */   Tl: () => (/* binding */ formatPrizeMan),
/* harmony export */   Y6: () => (/* binding */ formatWeight),
/* harmony export */   YK: () => (/* binding */ formatManYen),
/* harmony export */   dp: () => (/* binding */ formatPrizeFromYen),
/* harmony export */   p6: () => (/* binding */ formatDate),
/* harmony export */   qo: () => (/* binding */ toArray)
/* harmony export */ });
/* unused harmony exports calculateGrowthRate, formatRaceRecord */
/* harmony import */ var date_fns_format__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(47347);
/* harmony import */ var date_fns_locale__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(21966);
...
function formatDate(dateString) {
    ...
    try {
        ...
        return (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(date, "yyyy/MM/dd", {
...
// 成長率を計算する関数
function calculateGrowthRate(start, latest) {
    if (start === 0) return "-";
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   V: () => (/* binding */ normalizeImageUrl)
/* harmony export */ });
